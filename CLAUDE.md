...
Behavioral contracts to make AI coding agents deterministic. Not suggestions — structural enforcement.

Built on [Andrej Karpathy's observations](https://x.com/karpathy/status/2015883857489522876) with three additions: **enforcement gates**, **cross-session memory**, and **non-coding task coverage**.
