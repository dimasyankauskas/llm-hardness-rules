...
RAW_DIR      = RESULTS_DIR / "raw_versions"
...
SCENARIOS = [
    ...
    },
    {
        ...
        "prompt_suffix": "\n\nIMPORTANT FOR A/B TEST: Output text only. Do not trigger or invoke any bash tools, CLI commands, or file writing tools. Just print the code.",
...
def main():
    ...
    print("│  Baseline: Original GEMINI.md (max rules)               │")
    print("│  Treatment: My Version (5 condensed rules)                 │")
...
Return ONLY the JSON object, no other text.""",
    ...
    report_path = RESULTS_DIR / "report_versions.md"
